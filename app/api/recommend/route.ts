...
export async function POST(req: Request) {
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      contents: prompt,
      // Notice: We removed the strict responseSchema json formatting here
      // because your original <RoadmapDisplay /> component expects standard Markdown text!
    });

    // Extract the raw text generated by Gemini
